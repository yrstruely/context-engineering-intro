...

{
  ...
  "language": "typescript",
  "sourceContext": [
    "apps/ip-hub-backend/features/011-onboarding/phase1-core-dashboard.feature",
    "specs/02-dashboard-overview/bffe-spec.md",
    "specs/02-dashboard-overview/cqrs-contract.md",
    "specs/02-dashboard-overview/core-services-spec.md",
    "specs/02-dashboard-overview/non-functional-requirements.md"
  ]
}
...

{
  ...
  "implementationNotes": [
    "Created DashboardSummary interface in types.ts",
    "Added factory functions for applications",
...
**BFFE Endpoints** (from specs/02-dashboard-overview/bffe-spec.md):
...
interface DashboardSummaryResponse {
  ...
  countsByType: {
    ...
    trademarks: number
    copyrights: number
    utilityCertificates: number
  }
  inProgressCount: number
  pendingReviewCount: number
}

// Application in Progress Response
interface ApplicationInProgressResponse {
...
From `specs/02-dashboard-overview/non-functional-requirements.md`:
- **Performance**: Dashboard load < 2s (95th percentile)
- **API Response**: P95 latency < 300ms for queries
- **Throughput**: Support 100+ concurrent users
- **Security**: All endpoints require authentication
- **Data Accuracy**: Portfolio counts match actual database state
