...
1. **Run Cucumber.js Dry Run**
   - Execute: `npx nx test:e2e:local ip-hub-backend -- test/e2e/features/011-onboarding/ --dry-run`
...
### Directory Structure
- **Feature Files**: `apps/ip-hub-backend/features/011-onboarding/*.feature`
...
module.exports = {
  default: {
    paths: ['apps/ip-hub-backend/features/011-onboarding/*.feature'],
...
npx cucumber-js apps/ip-hub-backend/features/011-onboarding/*.feature --dry-run --format progress
